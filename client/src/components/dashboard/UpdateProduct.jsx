...
function UpdateProduct({
  ...
  const [formData, setFormData] = useState({
    name: product.name,
    type: product.type,
    subtypes: product.subtypes.split(" "),
  ...
  const handleTypeChange = (e) => {
    setFormData({ ...formData, type: e.target.id, subtypes: [] });
  };
