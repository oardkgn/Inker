  ...
  return (
    <div className=" w-full min-h-[1000px] flex flex-col gap-4">
      ...
      <div className=" w-full">
        ...
        <div className="flex flex-col bg-transparent gap-4 p-2">
          {tabPos == 206 &&
            items.map((item, key) => {
              return (
                <div
                ...
                >
                  ...
                  <div className=" bg-transparent text-priwhi">
                    <p className=" bg-transparent text-lg text-gray-500 p2-4">{setTime(item[1].order_time)}</p>
                    <p className=" bg-transparent text-2xl px-4">Total - {item[1].total_price}$</p>
                  </div>
                </div>
              );
            })}
