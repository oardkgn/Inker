...
function Search() {
  ...
  return (
    <div className=" max-w-[2440px] mx-auto min-h-[760px] p-4 flex gap-4">
        {/* Side Nav Bar */}
      <div className=" min-w-[270px] h-full bg-pribla rounded-lg text-xl text-priwhi p-2 flex flex-col gap-2">
        <button
        ...
        >
          <p className=" pl-4 py-4 bg-transparent">Books </p>
        ...
        >
          <p className=" pl-4 py-4 bg-transparent">Pens </p>
        ...
        >
          <p className=" pl-4 py-4 bg-transparent">Office </p>
        ...
        >
          <p className=" pl-4 py-4 bg-transparent">Stationary </p>
      ...
      <div className=" flex-1">
        ...
        <div className=" grid grid-cols-5 grid-rows-2 gap-8 gap-y-16 p-4">
