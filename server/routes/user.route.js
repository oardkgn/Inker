...
import { addToCart, delCart, delCartItem, deleteUser, dislikeProduct, getCartItems, getUserLikes, getUserOrders, isLiked, likeProduct, makeOrder, searchProducts, update } from "../controllers/user.controller.js";
...
router.delete("/delCartItem/:email,:id", verifyToken, delCartItem);
